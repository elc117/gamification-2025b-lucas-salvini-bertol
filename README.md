...
- **`MenuScreen`**: Comecei com a tela mais simples para testar os conceitos básicos. A ideia era apenas mostrar uma imagem e responder a um toque. A descoberta foi a facilidade do `Gdx.input.justTouched()`, que me permitiu criar uma primeira tela interativa sem complexidade, servindo como um "Olá Mundo!" para o projeto.
...
### _Parte 2.2_: A Criação da lógiica das telas
